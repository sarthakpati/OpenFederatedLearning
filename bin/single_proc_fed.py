...
def federate(flplan, 
    ...
    local_outputs_directories = {name: os.path.join(local_outputs_direcory, name) for name in collaborator_common names}
    ...
    for collaborator_common_name in collaborator_common_names:
        collaborators[collaborator_common_name] = \
            create_collaborator_object_from_flplan(flplan,
                                                   ...
                                                   weights_dir,
                                                   metadata_dir, 
                                                   local_outputs_direcory=local_outputs_direcories[collaborator_common_name],
