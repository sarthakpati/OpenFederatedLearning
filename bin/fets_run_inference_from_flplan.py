...
def main(plan, fetsai_model_weights_filename, fetsai_native_model_weights_filepath, data_dir, logging_config_path, logging_default_level, logging_directory, model_device):
    ...
    if fets-ai_model_weights_filename is not None and native_model_weights_filepathflplan['model_object_init']['init_kwargs']
    flplan['model_object_init']['init_kwargs'].update({}) WORKING HERE
